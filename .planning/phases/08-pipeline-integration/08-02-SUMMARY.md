...
plan: 02
subsystem: api
tags: [sports-trading, ingame, budget, odds, pytest]
requires:
  - phase: 08-pipeline-integration
    provides: pre-game implied_home_prob cache entries and BudgetCoordinator wallet refresh support
provides:
...
affects: [09-live-validation, ingame_trader, budget_coordinator, sports_data]
tech-stack:
  added: []
  patterns: [pre-trade in-game value-bet gating, refresh-before-budget in trading paths]
key-files:
  created: [.planning/phases/08-pipeline-integration/08-02-SUMMARY.md]
  modified:
...
requirements-completed: [PIPE-02, PERS-01]
duration: 6 min
